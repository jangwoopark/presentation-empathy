...
trial { picture inst; duration=6000; code="inst";} instructions;
trial { picture fix; duration=6000; code="fixation";} fixation;
trial { picture fix; duration=12000; code="fixing";} fixing;

trial { picture bn; duration=3000; code="p01n"; } p01n;
trial { picture ye; duration=3000; code="p13e";} p13e;
trial { picture ce; duration=3000; code="p02e";} p02e;
trial { picture abn; duration=3000; code="p14n";} p14n;
trial { picture fn; duration=3000; code="p03n";} p03n;
trial { picture adn; duration=3000; code="p15n";} p15n;
trial { picture ge; duration=3000; code="p04e";} p04e;
trial { picture afn; duration=3000; code="p16n";} p16n;
trial { picture ie; duration=3000; code="p05e";} p05e;
trial { picture rn; duration=3000; code="p09n";} p09n;
trial { picture ke; duration=3000; code="p06e";} p06e;
trial { picture se; duration=3000; code="p10e";} p10e;
trial { picture nn; duration=3000; code="p07n";} p07n;
trial { picture ue; duration=3000; code="p11e";} p11e;
trial { picture pn; duration=3000; code="p08n";} p08n;
trial { picture xn; duration=3000; code="p12n";} p12n;
trial { picture qe; duration=3000; code="p09e";} p09e;
trial { picture jn; duration=3000; code="p05n";} p05n;
trial { picture tn; duration=3000; code="p10n";} p10n;
trial { picture ln; duration=3000; code="p06n";} p06n;
trial { picture vn; duration=3000; code="p11n";} p11n;
trial { picture me; duration=3000; code="p07e";} p07e;
trial { picture we; duration=3000; code="p12e";} p12e;
trial { picture oe; duration=3000; code="p08e";} p08e;
trial { picture zn; duration=3000; code="p13n";} p13n;
trial { picture ae; duration=3000; code="p01e";} p01e;
trial { picture aae; duration=3000; code="p14e";} p14e;
trial { picture dn; duration=3000; code="p02n";} p02n;
trial { picture ace; duration=3000; code="p15e";} p15e;
trial { picture ee; duration=3000; code="p03e";} p03e;
trial { picture aee; duration=3000; code="p16e";} p16e;
trial { picture hn; duration=3000; code="p04n";} p04n;
